...
export type FormEmailResult =
  | { ok: true; email: FormEmailPayload }
...
export function buildContactEmail(formData: FormData): FormEmailResult {
...
export function buildToolingQuestionnaireEmail(formData: FormData): FormEmailResult {
